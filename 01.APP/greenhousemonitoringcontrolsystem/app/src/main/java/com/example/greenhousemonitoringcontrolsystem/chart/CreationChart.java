package com.example.greenhousemonitoringcontrolsystem.chart;
...
public class CreationChart {
     ...
     * @param d
     */
    public static void addEntry(LineChart chart, DBData d) {
        LineData data = chart.getData();
        xValues.add(d.getCreateDateTime());
        List<LineDataSet> dataSet = new ArrayList<LineDataSet>();
        float[] values = {Float.parseFloat(d.getTemp()), Float.parseFloat(d.getHumi()),
                Float.parseFloat(d.getLight()), Float.parseFloat(d.getTrhumi())};
        if (data != null && data.getDataSetCount() > 0) {
            ...
            LineData lineData = new LineData(dataSet.get(0), dataSet.get(1), dataSet.get(2), dataSet.get(3));
    ...
    private static LineDataSet createSet(int i) {
        ...
        switch (i) {
            ...
            case 2:
                ...
                break;
            case 3:
                set = new LineDataSet(null, "土壤湿度");
                set.setColor(Color.rgb(178, 255, 102)); //折线颜色
                break;
            default:
